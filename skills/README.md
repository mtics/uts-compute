...
- `consult-platform-docs` — when unsure about a platform operation, or when the user needs a capability the plugin does not expose, consult the official UTS HPC/iHPC docs (`docs.refresh` → `uts://docs-cache`) before guessing or declining.
